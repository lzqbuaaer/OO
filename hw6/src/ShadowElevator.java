...
public class ShadowElevator {
    ...
    public ShadowElevator(Elevator elevator, PersonRequest target) {
        ...
        if (elevator.getInReset()) {
            this.personNum = 0;
            this.full = elevator.getResetRequest().getCapacity();
            this.rate = elevator.getResetRequest().getSpeed();
            this.cost = 600;
            this.reqTab = new RequestTable(elevator.getReqTab().getId());
